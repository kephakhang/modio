...
public class KeyGenerator {
	...
	private static final String tossApiTestKey = "sk_test_Q0kzz7rkWyQ0kzz7rkWy" ;
	private static final String tossApitKey = "sk_live_6o2M31WO876o2M31WO87" ;
	...
	public static String getTossKey(boolean commercial){
		if( commercial )
			return tossApitKey ;
		else
			return tossApiTestKey ;
	}
	...
	public static void main(String[] argv) {
		System.out.println(KeyGenerator.password("qwe123.")) ;
	}
