    ...
    return {
        ...
        execute: function() {
            SignupComponent = (function () {
                function SignupComponent(dl, setting, router) {
                ...
                SignupComponent.prototype.nextTab = function (elem) {
                    $(elem).next().find('a[data-toggle="tab"]').click();
                };
                SignupComponent.prototype.prevTab = function (elem) {
                ...
                SignupComponent.prototype.onAgree = function () {
