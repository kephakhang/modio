System.register(['angular2/core', 'angular2/common', 'angular2/router', './../../services/setting'], function(exports_1) {
    ...
    var SharecontentstrackingComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            SharecontentstrackingComponent = (function () {
                function SharecontentstrackingComponent(setting, params) {
                    var _this = this;
                    ...
                    var url = this.setting.hostUrl +
                        ...
                        '&filter=' + '0' +
                        '&option=' + '6' +
                        '&optionParam=' + this.url.params.id;
                    console.log(url);
                ...
                SharecontentstrackingComponent.prototype.return_uuid = function () {
                    return this.url.params.id;
                };
                SharecontentstrackingComponent.prototype.loadMore = function () {
                    var _this = this;
                    this.page++;
                    var xhr = new XMLHttpRequest();
                    var url = this.setting.hostUrl +
                ...
                SharecontentstrackingComponent = __decorate([
                    core_1.Component({
                        selector: 'sharecontentstracking',
                        templateUrl: 'src/components/sharecontentstracking/sharecontentstracking.html',
                        providers: [setting_1.Setting],
                        directives: [common_1.CORE_DIRECTIVES, common_1.FORM_DIRECTIVES, router_1.ROUTER_DIRECTIVES]
                    }), 
                    __metadata('design:paramtypes', [setting_1.Setting, router_2.RouteParams])
                ], SharecontentstrackingComponent);
                return SharecontentstrackingComponent;
            })();
            exports_1("SharecontentstrackingComponent", SharecontentstrackingComponent);
        }
    }
});
