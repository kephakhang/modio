System.register(['angular2/core', 'angular2/common', './progress'], function(exports_1) {
    ...
    var core_1, common_1, progress_1;
    var Bar;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            Bar = (function () {
                ...
                Bar = __decorate([
                    ...
                    __metadata('design:paramtypes', [progress_1.Progress])
                ], Bar);
                return Bar;
            })();
            exports_1("Bar", Bar);
