System.register(['angular2/core', 'angular2/router', './../../services/dribbble', './../../services/setting'], function(exports_1) {
    ...
    return {
        ...
        execute: function() {
            SharecontentsComponent = (function () {
                function SharecontentsComponent(dl, setting, category, filter, btn) {
                    var _this = this;
                    this.name = 'World';
                    this.posts = new Array();
                    this.page = 0;
                    this.my_btn_count = 2;
                    this.buy_btn_count = 3;
                ...
                SharecontentsComponent.prototype.routerCanDeactivate = function (next, prev) {
                    window.scrollTo(0, 0);
                    return true;
                };
                SharecontentsComponent.prototype.gotoPost = function (id) {
                    alert(id);
                };
                SharecontentsComponent.prototype.loadMore = function () {
                    var _this = this;
                    this.page++;
                    var xhr = new XMLHttpRequest();
                    var url;
                ...
                SharecontentsComponent.prototype.ngOnInit = function () {
                };
                SharecontentsComponent.prototype.ngOnChanges = function (changes) {
                };
                SharecontentsComponent = __decorate([
                    core_1.Component({
                ...
                ], SharecontentsComponent);
                return SharecontentsComponent;
            })();
            exports_1("SharecontentsComponent", SharecontentsComponent);
        }
    }
});
