System.register(['angular2/core', 'angular2/http', 'rxjs/add/operator/share'], function(exports_1) {
    ...
    return {
        ...
        execute: function() {
            Dribbble = (function () {
                ...
                Dribbble.prototype.postRequest = function (url, json) {
                ...
                Dribbble.prototype.putRequest = function (url, json) {
                    return new Promise(function (resolve, reject) {
                        var xhr = new XMLHttpRequest();
                        xhr.onreadystatechange = function () {
                            if (xhr.readyState === 4) {
                ...
                Dribbble.prototype.getRequest = function (url) {
                    return new Promise(function (resolve, reject) {
                        var xhr = new XMLHttpRequest();
                        xhr.onreadystatechange = function () {
                            if (xhr.readyState === 4) {
