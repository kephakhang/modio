/*! ngActivityIndicator - v0.1.5 (https://github.com/voronianski/ngActivityIndicator) */ ! function(a, b) {
    "use strict";
    var c = "CircledGrey",
        d = {
        ...
        e = function(a) {
            var c = a.match(/([A-Z]?[^A-Z]*)/g).slice(0, -1),
                e = c[0],
                f = c[1].toLowerCase(),
                g = b.element(d[e]);
            return g.addClass("Circled" === e ? "ai-" + f + "-spin" : "ai-" + f + "-parent"), g
        };
    b.module("ngActivityIndicator", []).provider("$activityIndicator", function() {
        ...
        return {
            ...
            compile: function(a, d) {
                var f = d.ngActivityIndicator || c,
                    g = e(f);
                if ("BODY" === a[0].nodeName) {
                    var h = b.element(document.querySelectorAll("[ng-view]"));
                    h.attr("ng-hide", "AILoading")
                }
                a.append(g)
            }
        }
